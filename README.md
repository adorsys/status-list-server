...
This project uses [release-plz](https://release-plz.dev/) with [Conventional Commits](https://www.conventionalcommits.org/) to automate versioning and changelog generation. Every push to `main` branch opens or updates a Release PR. Merging that PR creates a git tag and a GitHub Release automatically.
