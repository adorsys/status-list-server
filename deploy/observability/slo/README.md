...
| 14d / 7d cert expiry | `alerting.rules.yml` (1209600 / 604800 s), `deploy/helm/chart/values.yaml` (`slo.certExpiryWarnSeconds` / `certExpiryCriticalSeconds`), `thresholds.json`, this doc |
